...
void main(){
    ...
    float angle0 = angleRange*noise(uv, t, 3.14, freq1) + angleOffset;
    float angle1 = angleRange*noise(uv, t, 3.14, freq2) + angleOffset;
    float angle2 = angleRange*noise(uv, t, 3.14, freq3) + angleOffset;
    float texel0 = texel * amp1;
    float texel1 = texel * amp2;
    float texel2 = texel * amp3;
